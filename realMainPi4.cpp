...
int currentStatus;  //A store for the single integers read from 'readPinFile'
int previousStatus = 0; //A store for the last/previous value of 'currentStatus'
//fstream ifs;
//fstream ofs;
...
cout << "GPIO 4 is level " << gpioRead(4) << endl;
//--------------------------------------------------------------//
